...
import cn.geekslife.designpattern.iterator.Product
...
class ProductSpec extends Specification {
    ...
    def "产品类应该正确初始化和访问属性"() {
        given:
        Product product = new Product("笔记本电脑", "电子产品", 5999.0, 10)
    ...
    def "产品类应该正确实现equals和hashCode方法"() {
        given:
        Product product1 = new Product("笔记本电脑", "电子产品", 5999.0, 10)
        Product product2 = new Product("笔记本电脑", "电子产品", 5999.0, 10)
        Product product3 = new Product("手机", "电子产品", 3999.0, 20)
