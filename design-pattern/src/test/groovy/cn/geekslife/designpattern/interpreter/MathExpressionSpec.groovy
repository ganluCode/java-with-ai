...
class MathExpressionSpec extends Specification {
    ...
    def "数学表达式应该能够计算简单算术表达式"() {
        given:
        MathExpression expr1 = new MathExpression("10 + 5")
        MathExpression expr2 = new MathExpression("10 - 5")
        MathExpression expr3 = new MathExpression("10 * 5")
        MathExpression expr4 = new MathExpression("10 / 5")
    ...
    def "数学表达式应该能够处理带括号的表达式"() {
        given:
        MathExpression expr = new MathExpression("(10 + 5) * 2")
    ...
    def "数学表达式应该能够与上下文交互"() {
        given:
        MathExpression expr = new MathExpression("10 + 5")
