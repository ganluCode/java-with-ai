...
class FilterIteratorSpec extends Specification {
    ...
    def "过滤迭代器应该支持基于条件的过滤"() {
        ...
        com.example.iterator.ConcreteFilterIterator<Integer> iterator = new com.example.iterator.ConcreteFilterIterator<>(aggregate, evenFilter)
    ...
    def "过滤迭代器应该支持修改过滤条件"() {
        ...
        com.example.iterator.ConcreteFilterIterator<Integer> iterator = new com.example.iterator.ConcreteFilterIterator<>(aggregate)
    ...
    def "过滤迭代器应该正确处理边界条件"() {
        ...
        com.example.iterator.ConcreteFilterIterator<Integer> iterator = new com.example.iterator.ConcreteFilterIterator<>(aggregate, greaterThanFilter)
    ...
    def "过滤迭代器应该支持空集合"() {
        ...
        com.example.iterator.ConcreteFilterIterator<Integer> iterator = new com.example.iterator.ConcreteFilterIterator<>(aggregate, filter)
    ...
    def "过滤迭代器应该支持无匹配元素的情况"() {
        ...
        com.example.iterator.ConcreteFilterIterator<Integer> iterator = new com.example.iterator.ConcreteFilterIterator<>(aggregate, noMatchFilter)
