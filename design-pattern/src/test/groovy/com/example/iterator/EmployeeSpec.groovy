...
class EmployeeSpec extends Specification {
    ...
    def "员工类应该正确初始化和访问属性"() {
        given:
        com.example.iterator.Employee employee = new com.example.iterator.Employee("张三", "技术部", 8000.0, 25)
    ...
    def "员工类应该正确实现equals和hashCode方法"() {
        given:
        com.example.iterator.Employee employee1 = new com.example.iterator.Employee("张三", "技术部", 8000.0, 25)
        com.example.iterator.Employee employee2 = new com.example.iterator.Employee("张三", "技术部", 8000.0, 25)
        com.example.iterator.Employee employee3 = new com.example.iterator.Employee("李四", "销售部", 6000.0, 28)
